# arm64-v8a native core binaries

Place trusted, release-built Android `arm64-v8a` native binaries here when native tunnel execution is added.

Expected filenames supported by the app code:
